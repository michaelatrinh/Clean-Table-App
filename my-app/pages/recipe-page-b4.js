...
export default function RecipePage({
    recipeimage = "/beefbrocpasta.png",
    recipetitle = "Beef Broccoli Noodles",
...
const HandleClick =() => { 
      ...
      return <RecipeContainer>
        ...
        <RecipeButton onClick="https://www.marionskitchen.com/amp/beef-and-broccoli-noodle/"></RecipeButton>
        </Mid3>
