...
export default function RecipePage({
    recipeimage = "/onionchicbake.png",
    recipetitle = "Baked Chicken And Potatoes",
    ...
    ptext = "If wasted food was a country, it would be the third largest producer of carbon dioxide in the world, after the United States and China."
      ...
      <ButtonContainer>
          <RecipeButton onClick={()=>window.open("https://cleananddelicious.com/baked-chicken-with-potatoes-onions-video/")}></RecipeButton>
      </ButtonContainer>
