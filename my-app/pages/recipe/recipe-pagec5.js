...
export default function RecipePage({
    ...
    ptext = " Excess food, scraps, and even some bones or other animal drippings are great ingredients for various stocks or broths."
      ...
      return <RecipeContainer>
        ...
        <ButtonContainer>
            <RecipeButton onClick={()=>window.open("https://www.foodnetwork.com/recipes/food-network-kitchen/chicken-fettuccine-alfredo-3364118")}></RecipeButton>
       </ButtonContainer>
