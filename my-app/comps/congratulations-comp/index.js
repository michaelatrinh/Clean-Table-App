...
const Congrats = ({
    ...
    return <CongratsContainer width={width}>
              ...
              <p>
      You’ve just You’ve just successfully went through the tutorial pages! Entered in your grocery list and start to keep track of the food in your household. <br></br><br></br>
